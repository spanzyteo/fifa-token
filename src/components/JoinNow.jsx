  ...
  return (
    <div className="mt-20 flex flex-col md:flex-row items-center justify-center gap-4">
      ...
      <div className="uppercase md:ml-[10rem] md:mt-[4rem] mt-4 flex flex-col gap-4">
        ...
        <button className="text-white text-2xl border-2 p-3 px-0 md:px-5 rounded-full font-semibold border-green-400 hover:bg-green-400 hover:border-white hover:text-black hover:font-bold transition duration-300 ease active:opacity-70">
          Buy Now
        </button>
      </div>
    </div>
